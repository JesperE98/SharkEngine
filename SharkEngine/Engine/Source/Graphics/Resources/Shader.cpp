...
Shader::Shader(const char* vertexPath, const char* fragmentPath) {
	...
	SHARK_LOG(Material, "Vertex Shader Path: {}", fs::absolute(vertexPath).string());
	...
	try {
		vShaderFile.open(vertexPath); // Open the file
		fShaderFile.open(fragmentPath); // Open the file
		...
		SHARK_ERR(Material, "Shader::Shader() - Failed to read shader files at paths: {} and {}", vertexPath, fragmentPath);
